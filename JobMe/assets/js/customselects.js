//var isDotnetReferenced = false;
//var dotnetHelper = null;

function sendControlValue(id, value) {
    return dotnetHelper.invokeMethodAsync('JsControlValueChanged', id, value);
}

function sendControlMultiValue(id, value) {
    return dotnetHelper.invokeMethodAsync('JsControlMultiValueChanged', id, value);
}

var Select2Selects = null;

function initSelects(componentRef) {

    //if (!isDotnetReferenced) {
    //    isDotnetReferenced = true;
    //    dotnetHelper = componentRef;
    //}

    dotnetHelper = componentRef;

    Select2Selects = function () {
        ...
        var _componentSelect2 = function () {
            ...
            $('.select').on('change', function (e) {
                ...
                if($(this).attr('multiple') === 'multiple')
                    sendControlMultiValue($(this).attr('id'), $(this).val());
                else
                    sendControlValue($(this).attr('id'), $(this).val());
            });
