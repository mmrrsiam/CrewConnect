var MarkerClusterer = (function () {
    ...
    _createClass(ClusterIcon, [{
      ...
      value: function show() {
        if (this.div_) {
          ...
          img += "'>";
          this.div_.innerHTML = img + "<div " + "aria-label='" + ariaLabel + "' " + "tabindex='0' " + "style='" + "position: absolute;" + "top: " + this.anchorText_[0] + "px;" + "left: " + this.anchorText_[1] + "px;" + "color: " + this.textColor_ + ";" + "font-size: " + this.textSize_ + "px;" + "font-family: " + this.fontFamily_ + ";" + "font-weight: " + this.fontWeight_ + ";" + "font-style: " + this.fontStyle_ + ";" + "text-decoration: " + this.textDecoration_ + ";" + "text-align: center;" + "width: " + this.width_ + "px;" + "line-height:" + this.height_ + "px;" + "'>" + "<span aria-hidden='true'>" + this.sums_.text + "</span>" + "</div>";
  ...
  function () {
    ...
    _createClass(Cluster, [{
      ...
      value: function isMarkerAlreadyAdded_(marker) {
        var i;
  ...
  function () {
    ...
    function MarkerClusterer(map, opt_markers, opt_options) {
      ...
      this.ariaLabelFn = opt_options.ariaLabelFn || function () {
        return "";
      };
    ...
    _createClass(MarkerClusterer, [{
      ...
      value: function onAdd() {
        ...
        this.listeners_ = [google.maps.event.addListener(this.getMap(), "zoom_changed", function () {
          ...
          var maxZoom = Math.min(this.getMap().maxZoom || 100, this.getMap().mapTypes[this.getMap().getMapTypeId()].maxZoom);
      ...
      value: function setMinimumClusterSize(minimumClusterSize) {
      ...
      key: "setZoomOnClick",
      value: function setZoomOnClick(zoomOnClick) {
      ...
      value: function setAverageCenter(averageCenter) {
      ...
      key: "setIgnoreHidden",
      value: function setIgnoreHidden(ignoreHidden) {
      ...
      value: function setEnableRetinaIcons(enableRetinaIcons) {
      ...
      value: function setImageExtension(imageExtension) {
      ...
      key: "setImageSizes",
      value: function setImageSizes(imageSizes) {
      ...
      key: "setBatchSizeIE",
      value: function setBatchSizeIE(batchSizeIE) {
      ...
      key: "setClusterClass",
      value: function setClusterClass(clusterClass) {
      ...
      key: "resetViewport_",
      value: function resetViewport_(opt_hide) {
      ...
      key: "createClusters_",
      value: function createClusters_(iFirst) {
        var i, marker;
        var mapBounds;
        var cMarkerClusterer = this;
      ...
      key: "CALCULATOR",
      value: function CALCULATOR(markers, numStyles) {
        var index = 0;
        var title = "";
